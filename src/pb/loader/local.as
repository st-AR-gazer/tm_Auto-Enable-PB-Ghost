namespace Loader {
    ...
    namespace Local {
        ...
        void _Worker(const string &in mapUid) {
            ...
            log("Local PB kickoff: hint=" + bestHint + " ms", LogLevel::Debug, 34, "Loader::Local", "", "\\$f80");

            auto replays = Database::GetReplays(mapUid);
            if (replays.Length == 0) {
                log("No local replays found for map " + mapUid, LogLevel::Info, 40, "Loader::Local", "", "\\$f80");
            ...
            log("Found " + replays.Length + " local replays for map " + mapUid, LogLevel::Debug, 40, "Loader::Local", "", "\\$f80");
        ...
        void _DoLoad(const string &in path) {
            log("Loading PB replay from: " + path, LogLevel::Debug, 20, "Loader::Local", "", "\\$f80");
